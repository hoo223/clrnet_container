...
ori_img_w = 2560 # original image width
ori_img_h = 1440 # original image height
img_w = 800 # model input size
img_h = 320 # model input size
cut_height = 720 # 도로 영역의 시작 y 좌표 -> 너무 작으면 성능이 떨어짐
